        ...
        <contents className={styles.contents}>
            ...
            <div className={styles.butterflyPatterns}>
              <div className={styles.buttfly1}>
                ...
                <p>Ornithoptera goliath has a wingspan up to 28 centimetres (11 in). This makes it the world's second largest butterfly. The African giant swallowtail reaches an almost equal wingspan.
