        ...
        <contents className={styles.contents}>
            ...
            <div className={styles.butterflyPatterns}>
              <div className={styles.buttfly1}>
                ...
                <p>
                    The Trogonoptera trojana, known as the Rajah Brooke's Birdwing, is an exquisite and large butterfly, hailing from the Birdwing genus that captivates with its sheer size and stunning coloration. Typically, the wingspan of this magnificent creature can stretch up to about 7 inches, making it one of the larger species within the butterfly realm. The male of the species boasts a velvety black color on the upper side of its wings, dramatically offset by an electric green or turquoise hue that forms broad, iridescent bands across the forewings and a series of smaller, similarly colored streaks on the hindwings. This contrast is not only striking but serves as a natural spectacle in the wild. The female, while larger, tends to have a more subdued color palette, with wings that are predominantly brown or black, accented with white or cream-colored spots. The Trogonoptera trojana's body is slender, with the thorax and abdomen often matching the dark hue of the wings, creating a cohesive and sleek appearance. The elegant, yet powerful flight of this butterfly, coupled with its vivid coloration, makes it a breathtaking sight in its natural rainforest habitats</p>
                <img src={"/parides_agavus.png"} alt="Trogonoptera Trojana" width={500} />
                </div>
            </div>
        </contents>
    );
