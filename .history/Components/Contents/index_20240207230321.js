            ...
            <div className={styles.butterflyPatterns}>
              <div className={styles.buttfly1}>
                ...
                <p>The Parides agavus, also known as the Agavus Swallowtail, is a visually striking butterfly that belongs 
                    ...
                    Its distinctive tail-like extensions on the hindwings, characteristic of swallowtail butterflies, enhance its elegant silhouette, making the Parides agavus a remarkable specimen in the butterfly world.</p>
