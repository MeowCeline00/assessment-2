        ...
        <contents className={styles.contents}>
            ...
            <div className={styles.butterflyPatterns}>
              <div className={styles.buttfly1}>
                ...
                <p>Morpho peleides is recognized by the iridescent blue coloration on the dorsal (top) side of the wings (Figure 1). Conversely, the undersides of the wings are brown and have a cryptic coloration and pattern (Figure 2). Large eyespots are present on the ventral (bottom) side of the forewings and hindwings. The number of forewing eyespots on each individual may vary (Young 1982). This coloration serves as protection from predators by making the butterfly somewhat camouflaged in the forest, and the eyespots can startle or intimidate potential predators. They are large butterflies, with adult wingspan measuring 5-8 inches (127-203 mm) (Rainforest Alliance 2015).</p>
                <img src={"/agrias_aedon_hewitson.png"} alt="Agrias Aedon Hewitson" width={500} />
                </div>
            </div>
        </contents>
