            ...
            <div className={styles.butterflyPatterns}>
              <div className={styles.buttfly1}>
                ...
                <p>The male's upperside is black. Forewing with a broad white interrupted band from the subcostal nervure 
                    ...
                    markings as on the upperside, but the crimson spots and crescent-shaped markings on the hindwing larger. Antennae, thorax and abdomen above at base, black; head and rest of the abdomen bright crimson; beneath: iho palpi, the sides of the thorax and abdomen crimson.[5][6]
