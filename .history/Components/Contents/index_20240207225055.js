            ...
            <div className={styles.butterflyPatterns}>
              <div className={styles.buttfly1}>
                ...
                <p>Ornithoptera goliath has a wingspan up to 11 in. This makes it the world's second largest butterfly. 
                    ...
                    There are some green spots in the cells of the golden area. The underside is similar to the upperside, but there is no black border. The edge is green. The spots in the cells of the golden area are black.
