            ...
            <div className={styles.butterflyPatterns}>
              <div className={styles.buttfly1}>
                ...
                <p>Ornithoptera goliath has a wingspan up to 11 in. This makes it the world's second largest butterfly. 
                    ...
                    At the outer edge there is a postdiscal chain of white spots. In the discal cell there is a cluster of white spots, sometimes shaped like an "E". The hindwings have a broad yellow postdiscal band with a chain of dark-brown spots in the cells. The underside is very like the upper but the colours are stronger.</p>
