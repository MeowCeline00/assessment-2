    ...
    return (
        <contents className={styles.contents}>
            ...
            <div className={styles.butterflyPatterns}>
              <div className={styles.butterflyPattern}>
                <div className={styles.butterflyDes}>
                ...
                <div className={styles.butterflyPic}>
                <img src={"/agrias_aedon_hewitson.png"} alt="Agrias Aedon Hewitson" width={200} />
                </div>
                </div>
                <div className={styles.butterflyPattern}>
                <div className={styles.butterflyDes}>
                ...
                <div className={styles.butterflyPic}>
                <img src={"/Danaus_plexippus.png"} alt="Danaus Plexippus" width={200} />
                </div>
                </div>
                <div className={styles.butterflyPattern}>
                <div className={styles.butterflyDes}>
                ...
                <div className={styles.butterflyPic}>
                <img src={"/morpho_peleides.png"} alt="Morpho Peleides" width={200} />
                </div>
                </div>
                <div className={styles.butterflyPattern}>
                <div className={styles.butterflyDes}>
                ...
                <p>Ornithoptera goliath has a wingspan up to 11 in. This makes it the world's second largest butterfly. 
                    ...
                    <div className={styles.butterflyPic}>
                <img src={"/ornithoptera_goliath.png"} alt="Ornithoptera Goliath" width={200} />
                </div>
                </div>
                ...
                <p>The male's upperside is black. Forewing with a broad white interrupted band from the subcostal nervure 
                    ...
                    <div className={styles.butterflyPic}>
                <img src={"/pachliopta_hector.png"} alt="Pachliopta Hector" width={200} />
                </div>
                </div>
                ...
                <div className={styles.butterflyPic}>
                <img src={"/parides_agavus.png"} alt="Parides Agavus" width={200} />
                </div>
                </div>
                ...
                <p>
                    ...
                    <div className={styles.butterflyPic}> 
                <img src={"/trogonoptera_trojana.png"} alt="Trogonoptera Trojana" width={200} />
                </div>
                </div>
            </div>
        </contents>
