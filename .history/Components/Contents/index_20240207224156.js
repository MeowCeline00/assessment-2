        ...
        <contents className={styles.contents}>
            ...
            <div className={styles.butterflyPatterns}>
              <div className={styles.buttfly1}>
                ...
                <br />As caterpillars, Monarchs are striped with yellow, black and white bands. Monarch caterpillars have a set of antennae-like tentacles at each end of their body. They reach about two inches in length before metamorphosis. The monarch chrysalis, where the caterpillar undergoes metamorphosis into the winged adult butterfly, is seafoam green with tiny yellow spots along its edge.</p>
                <img src={"/agrias_aedon_hewitson.png"} alt="Agrias Aedon Hewitson" width={500} />
                </div>
            </div>
        </contents>
