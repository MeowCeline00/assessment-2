        ...
        <contents className={styles.contents}>
            ...
            <div className={styles.butterflyPatterns}>
              <div className={styles.buttfly1}>
                ...
                featuring black veins and white spots along the edges. The males possess distinguishing black dots along the veins of their wings. Their orange color alerts predators to stay away.
