        ...
        <contents className={styles.contents}>
            ...
            <div className={styles.butterflyPatterns}>
              <div className={styles.buttfly1}>
                ...
                <img src={"/morpho_peleides.png"} alt="Pachliopta Hector" width={500} />
                </div>
                <div className={styles.buttfly6}>
                <h3>Parides Agavus</h3>
                <p>The Parides agavus, also known as the Agavus Swallowtail, is a visually striking butterfly that belongs to the Papilionidae family. Its wingspan can range from 3 to 4 inches, showcasing a bold contrast of colors and patterns. The primary coloration of its wings is a deep, glossy black, which serves as a dramatic backdrop for the vibrant red or pink bands that adorn the edges of its hindwings. These vivid markings are complemented by smaller, iridescent blue or green spots that add a touch of shimmer and complexity to its appearance. The butterfly's body is slender and predominantly black, with legs that may have hints of red. Its distinctive tail-like extensions on the hindwings, characteristic of swallowtail butterflies, enhance its elegant silhouette, making the Parides agavus a remarkable specimen in the butterfly world.</p>
                <img src={"/morpho_peleides.png"} alt="Parides Agavus" width={500} />
                </div>
            </div>
        </contents>
    );
